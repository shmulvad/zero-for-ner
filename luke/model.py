...
class LukeModel(nn.Module):
    ...
    def forward(
        ...
        attention_mask = self.compute_extended_attention_mask(word_attention_mask, entity_attention_mask)
    ...
    def compute_extended_attention_mask(
...
class EntityAwareSelfAttention(nn.Module):
    ...
    def forward(self, word_hidden_states, entity_hidden_states, attention_mask):
        ...
        # (batch_size, # attention heads, word size, word size)
